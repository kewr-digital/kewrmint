    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 22: {
          ...
          message.feature_support = FieldOptions_FeatureSupport.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const FeatureSet: MessageFns<FeatureSet> = {
  encode(
    ...
    if (
      message.enforce_naming_style !== undefined &&
      message.enforce_naming_style !== 0
    ) {
      writer.uint32(56).int32(message.enforce_naming_style);
    }
    if (
      message.default_symbol_visibility !== undefined &&
  ...
  toJSON(message: FeatureSet): unknown {
    ...
    if (
      ...
      obj.enforce_naming_style = featureSet_EnforceNamingStyleToJSON(
        message.enforce_naming_style
      );
    }
    if (
      message.default_symbol_visibility !== undefined &&
...
export const FeatureSet_VisibilityFeature: MessageFns<FeatureSet_VisibilityFeature> =
  {
    ...
    create(
      base?: DeepPartial<FeatureSet_VisibilityFeature>
    ): FeatureSet_VisibilityFeature {
      return FeatureSet_VisibilityFeature.fromPartial(base ?? {});
    },
    fromPartial(
      _: DeepPartial<FeatureSet_VisibilityFeature>
    ): FeatureSet_VisibilityFeature {
      const message = createBaseFeatureSet_VisibilityFeature();
      return message;
    },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 4: {
            ...
            message.overridable_features = FeatureSet.decode(
              reader,
              reader.uint32()
            );
            continue;
